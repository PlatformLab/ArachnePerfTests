...
void printStatistics(const char* label, uint64_t* rawdata, size_t count,
    ...
    printf("%s,%zu,%lu,%lu,%lu,%lu,%lu,%lu,%lu\n", label, count, avg,
            rawdata[count / 2], rawdata[0], rawdata[(int)(static_cast<double>(count)*0.99)],
            rawdata[(int)(static_cast<double>(count)*0.999)],rawdata[(int)(static_cast<double>(count)*0.9999)],
            rawdata[count-1]);
